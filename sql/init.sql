...
CREATE TABLE IF NOT EXISTS `bangumi_data` (
  ...
  `relations_anime` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_uca1400_as_ci DEFAULT NULL,
  `subjects` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_uca1400_as_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `upload_message` (
  ...
  `messageSentStatus` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Deprecated: legacy notifier sent status',
  `uploadTime` datetime(3) DEFAULT current_timestamp(3),
  `messageSkiped` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Deprecated: legacy notifier duplicate skip flag',
  PRIMARY KEY (`id`),
