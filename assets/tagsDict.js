const dict = {
  group: [
    ...
    { from: /Mabors( |-)Sub/gi, to: "幻之字幕组" },
    { from: /DHR/gi, to: "DHR动研字幕组" },
    ...
    { from: /WOLF\&RH/gi, to: "WOLF&RH 字幕组" },
    ...
    { from: /ANK-Raws/gi, to: "ANK-Raws 压制组" },
  ...
  source: [
    ...
    { from: /AT-X/gi, to: "AT-X" },
    { from: /Baha/gi, to: "巴哈姆特动画疯" },
    { from: /B-Global/gi, to: "哔哩哔哩国际" },
    { from: /CR/gi, to: "Crunchyroll" },
    { from: /Sentai/gi, to: "Hidive" },
    { from: /BiliBili|BL/gi, to: "哔哩哔哩动画" },
    { from: /(Acfun|AC)/gi, to: "Acfun" },
    { from: /(netflix|NF)/gi, to: "Netflix" },
  ],
  quality: [
    ...
    { from: /(HEVC|x265|H265)/gi, to: "HEVC" },
    { from: /Ma10p/gi, to: "Ma10p" },
    { from: /Main10/gi, to: "Main10" },
    { from: /8Bits|8Bit/gi, to: "8bit 色深" },
    { from: /Hi10p|10Bits|10Bit/gi, to: "10位色" },
    { from: /yuv420p10/gi, to: "YUV-4:2:0 10位色" },
  ...
  language: [
    ...
    { from: /JPSC|CHS_JP|Chs,Jap|简体双语/gi, to: "简日双语" },
    { from: /JSTC|CHT_JP/gi, to: "繁日双语" },
    { from: /Chs,Cht,Jap/gi, to: "简繁日多语" },
    { from: /CN/gi, to: "中文" },
    { from: /ENG/gi, to: "英语" },
  ...
  delete: [
    /(招募(翻译|时轴后期|后期|时轴))|(new-ani.me)|((1|4|7|10|一|四|七|十)月新番)/gi,
